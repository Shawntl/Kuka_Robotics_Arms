...
def setUpWorld(initialSimSteps=100,urdfRootPath=pybullet_data.getDataPath()):
    """
    ...
    # Load plane
    p.loadURDF(os.path.join(urdfRootPath,"plane.urdf"),[0, 0, -1], useFixedBase=True)

    sleep(0.1)
    p.configureDebugVisualizer(p.COV_ENABLE_RENDERING,0)
    # Load Baxter
    baxterId = p.loadURDF("/Users/songzhewei/bullet3/pybullet_robots-master/data/baxter_common/baxter_description/urdf/toms_baxter.urdf", useFixedBase=True)
